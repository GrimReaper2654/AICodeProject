...
function main() {
    ...
    */
    ...
    drawPolygon(square, {x: 100, y: 100}, Math.PI/4, 'rgba(255, 0, 0, 0.75)', {colour: '#696969', width: 10}, false);
    drawPolygon(square, {x: 100, y: 100}, false, 'rgba(0, 255, 0, 0.5)', {colour: '#696969', width: 10}, false);
